...
function Login() {
  ...
  return (
    <>
      <div className="dark:bg-indigo-950 dark:text-black bg-indigo-200 fixed z-100 top lg:left-[38%] md:left-[25%] sm:left-[20%] left-[13%] text-black-400 w-[23rem]  h-screen/2 mx-10 my-32">
        ...
        <form className="flex flex-col mx-12" onSubmit={login} id="login">
          <div className="bg-indigo-600/50 h-12 w-90 px-12 py-5">
            ...
            <input
              ...
              className="dark:bg-indigo-950 dark:text-black cursor-pointer rounded-lg pl-2"
              id="userName"
              name="userName"
          ...
          <div className="bg-indigo-600/50 h-12 w-90 px-12 py-12">
            ...
            <input
              ...
              className="dark:bg-indigo-950 dark:text-black cursor-pointer  ring-offset-0 rounded-lg pl-2"
              id="password"
              name="password"
